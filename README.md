...
| --- | --- | --- |
| **Sofia-SIP 1.13.17-gabpbx1**, built from source into `/usr/local` | `chan_sofia`'s SIP stack — **not a distro package** | tag `v1.13.17-gabpbx1` from [garacil/sofia-sip](https://github.com/garacil/sofia-sip) (a fork of [freeswitch/sofia-sip](https://github.com/freeswitch/sofia-sip)) — a **warning-clean build on GCC 14 / OpenSSL 3** (soname unchanged, `0.6.0`) |
...
git checkout v1.13.17-gabpbx1  # the release chan_sofia is built + tested against (warning-clean on GCC 14 / OpenSSL 3)
